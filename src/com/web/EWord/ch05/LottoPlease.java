...
//		int ran4 = (int) ((Math.random() * (max-min)) + min);
//		int ran5 = (int) ((Math.random() * (max-min)) + min);
//		int ran6 = (int) ((Math.random() * (max-min)) + min);
//		
...
//		
//		for(int i=0; i<=5; i++) {
//			ran[i]=(int)((Math.random() * (max-min)) + min);
//			if(i==5) {
...
//		Arrays.sort(ran);
//		
//		String[] strRan = new String[ran.length];
//		for (int i=0; i<ran.length; i++) {
//			strRan[i] = String.valueOf(ran[i]);
//		}
//		
//		System.out.println(Arrays.toString(strRan));
//		
//		LinkedHashSet<String> linkedHashSet = 
//				  new LinkedHashSet<>( Arrays.asList(strRan) );
//		
...
//		if(strArrayWithoutDuplicates.length!=ran.length) {
//			for(int j=0; j<=(ran.length-strArrayWithoutDuplicates.length);j++) {
//				ran[j]=(int)((Math.random() * (max-min)) + min);
//			}
//		}
...
//		ran[0] = (int) ((Math.random() * (max-min)) + min);
//		ran[1] = (int) ((Math.random() * (max-min)) + min);
//		ran[2] = (int) ((Math.random() * (max-min)) + min);
//		ran[3] = (int) ((Math.random() * (max-min)) + min);
//		ran[4] = (int) ((Math.random() * (max-min)) + min);
//		ran[5] = (int) ((Math.random() * (max-min)) + min);
